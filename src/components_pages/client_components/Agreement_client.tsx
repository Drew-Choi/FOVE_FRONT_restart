  ...
  return (
    <>
      ...
      <div className={style.agreement}>
        ...
        <br />
        <span>
          이 약관은 포브(FOVV)(전자상거래 사업자)가 운영하는 Fovv-Shop(이하
        ...
        <br />
        <span>
          &nbsp;&nbsp;① “몰”이란 포브(FOVV)가 재화 또는 용역(이하 “재화 등”이라
        ...
        <span>
          ...
          신고번호, 개인정보보호책임자등을 이용자가 쉽게 알 수 있도록 포브
          사이버몰(https://fovv-shop.com)의 초기 서비스화면(전면)에 게시합니다.
        ...
        <span>
          ...
          중단할 수 있고, 새로운 서비스로의 교체 기타 “몰”이 적절하다고 판단하는
          사유에 기하여 현재 제공되는 서비스를 완전히 중단할 수 있습니다.
        </span>
        <br />
        <span>
          &nbsp;&nbsp; ② 제1항에 의한 서비스 중단의 경우에는 “몰”이 정한
          방법으로 이용자에게 통지합니다. 다만, “몰”이 통제할 수 없는 사유로
        ...
        <span>
          ...
          약정이 없는 이상, 이용자가 대금을 지급한 날부터 7일 이내에 재화 등을
        ...
        <span>
          ...
          등의 대금을 받은 경우에는 대금을 받은 날부터 7영업일 이내에 환급하거나
          환급에 필요한 조치를 취합니다.
        </span>
        <br />
        <br />
        ...
        <br />
        <span>
          &nbsp;&nbsp;① 개인정보처리방침(https://fovv-shop.com/privacy)의 경우를
        ...
        <span>
          ...
          그 피해를 보상처리하기 위한 연락망(E-mail 등)을 사이트에 노출합니다.
        </span>
        <br />
        <span>
        ...
        <br />
        <br />
        <span>부 칙(시행일) 이 약관은 2023년 11월 01일부터 시행합니다.</span>
        <br />
        <br />
        <br />
        <br />
        ...
        <br />
        <span>
          “포브(FOVV)”는 회원가입, 주문안내, 배송안내 등 비광고성 정보를
          카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신
          차단하신 경우에는 일반 문자메시지로 보내 드립니다. 카카오톡 알림톡을
          통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우,
          알림톡 수신 중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해
          발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여
          주시기 바랍니다.
        </span>
        <br />
        <br />
